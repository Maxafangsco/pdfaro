...
export function DJVUToPDFTool({ className = '' }: DJVUToPDFToolProps) {
    ...
    return (
        <div className={`space-y-8 ${className}`.trim()}>
            ...
            {error && (
                <div className="p-4 rounded-xl bg-red-50/50 border border-red-200 text-red-700 flex items-start gap-3 animate-in fade-in slide-in-from-top-2" role="alert" data-testid="error-alert">
